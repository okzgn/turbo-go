...
package customNetHttp // import "golang.org/x/text/internal/gen"
...
var (
	...
	cldrVersion = flag.String("cldr",
		getEnv("CLDR_VERSION", CLDR_Version),
		"cldr version to use")
)
...
// Repackage rewrites a Go file from belonging to package xmain to belonging to
// the given package.
