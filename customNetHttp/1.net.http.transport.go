...
var http2client = InternalGodebugNew("http2client")
...
var (
	testHookEnterRoundTrip   = nopNothing
	testHookWaitResLoop      = nopNothing
	testHookRoundTripRetried = nopNothing
	testHookPrePendingDial   = nopNothing
	testHookPostPendingDial  = nopNothing

	testHookMu                     sync.Locker = fakeLocker{} // guards following
	testHookReadLoopBeforeNextRead             = nopNothing
)
