...
package customNetHttp // import "golang.org/x/text/internal/ucd"
...
// An UCDOption is used to configure a Parser.
type UCDOption func(p *Parser)
...
var (
	...
	KeepRanges UCDOption = keepRanges
)

// The Part option register a handler for lines starting with a '@'. The text
// after a '@' is available as the first field. Comments are handled as usual.
func UCDPart(f func(p *Parser)) UCDOption {
...
// a given handler.
func CommentHandler(f func(s string)) UCDOption {
	return func(p *Parser) {
		p.commentHandler = f
	}
}
...
func UCDNew(r io.Reader, o ...UCDOption) *Parser {
	p := &Parser{
