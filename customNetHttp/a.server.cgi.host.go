...
func (h *CgiHandler) stderr() io.Writer {
	if h.Stderr != nil {
		return h.Stderr
	}
	return os.Stderr
...
func (h *CgiHandler) ServeHTTP(rw ResponseWriter, req *Request) {
	root := h.Root
	if root == "" {
		root = "/"
	}
	...
	internalError := func(err error) {
		...
		Error(rw, "CGI error: "+err.Error(), 500)
	}
...
func (h *CgiHandler) printf(format string, v ...any) {
	if h.Logger != nil {
...
func (h *CgiHandler) handleInternalRedirect(rw ResponseWriter, req *Request, path string) {
